...
?>			
			...
			<div id="ripple_box">
				<div id="ripple_box1"><textarea rows="5" cols="65" name="ripple_content"  placeholder="댓글을 남겨보세요."></textarea>
				</div>
                <div id="ripple_box2"><a href="#"><input type="submit"  onclick="check_input()" value="등록"></a></div>
			</div>
			</form>
		</div> <!-- end of ripple -->
